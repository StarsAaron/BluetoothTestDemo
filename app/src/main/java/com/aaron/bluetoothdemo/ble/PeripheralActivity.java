...
import com.aaron.bluetoothdemo.utils.OutputStringUtil;

import java.util.UUID;

/**
 * 外围设备例子
 * Peripheral 模式，提供中心设备服务
 */
public class PeripheralActivity extends AppCompatActivity {
    public static final String TAG = "PeripheralActivity";
    ...
    private void initGATTServer() {
        ...
        AdvertiseCallback callback = new AdvertiseCallback() {
            ...
            public void onStartSuccess(AdvertiseSettings settingsInEffect) {
                ...
                initServices(PeripheralActivity.this);
            }
